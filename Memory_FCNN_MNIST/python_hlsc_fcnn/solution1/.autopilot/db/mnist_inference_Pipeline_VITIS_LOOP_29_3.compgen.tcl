...
set name mnist_inference_fpext_32ns_64_2_no_dsp_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_tile \
    op interface \
    ports { input_tile_address0 { O 6 vector } input_tile_ce0 { O 1 bit } input_tile_we0 { O 1 bit } input_tile_d0 { O 16 vector } } \
} "
} else {
