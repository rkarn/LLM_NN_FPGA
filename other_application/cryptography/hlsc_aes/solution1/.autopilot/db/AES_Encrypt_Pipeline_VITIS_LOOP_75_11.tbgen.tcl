set moduleName AES_Encrypt_Pipeline_VITIS_LOOP_75_11
set isTopModule 0
...
set C_modelName {AES_Encrypt_Pipeline_VITIS_LOOP_75_11}
set C_modelType { void 0 }
set C_modelArgList {
	{ state int 8 regular {array 16 { 2 2 } 1 1 }  }
	{ w int 32 regular {array 44 { 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "AES_Encrypt_Pipeline_VITIS_LOOP_75_11",
		"Protocol" : "ap_ctrl_hs",
...
set ArgLastReadFirstWriteLatency {
	AES_Encrypt_Pipeline_VITIS_LOOP_75_11 {
		state {Type IO LastRead 2 FirstWrite 2}
