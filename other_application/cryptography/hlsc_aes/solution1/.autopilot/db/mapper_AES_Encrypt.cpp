...
using hls::sim::Byte;
extern "C" void AES_Encrypt(Byte<1>*, Byte<1>*, Byte<4>*);
extern "C" void apatb_AES_Encrypt_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, volatile void * __xlx_apatb_param_key) {
...
__xlx_key__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_key)[i]);
  ...
  int __xlx_size_param_key = 4;
  int __xlx_offset_param_key = 0;
  int __xlx_offset_byte_param_key = 0*4;
  // DUT call
  AES_Encrypt(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data(), __xlx_key__tmp_vec.data());
