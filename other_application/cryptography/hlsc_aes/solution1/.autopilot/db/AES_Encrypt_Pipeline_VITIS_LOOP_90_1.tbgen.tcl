set moduleName AES_Encrypt_Pipeline_VITIS_LOOP_90_1
set isTopModule 0
...
set C_modelName {AES_Encrypt_Pipeline_VITIS_LOOP_90_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ state int 8 regular {array 16 { 0 0 } 0 1 }  }
	{ w int 32 regular {array 44 { 1 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "AES_Encrypt_Pipeline_VITIS_LOOP_90_1",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	state { ap_memory {  { state_address0 mem_address 1 4 }  { state_ce0 mem_ce 1 1 }  { state_we0 mem_we 1 1 }  { state_d0 mem_din 1 8 }  { state_address1 MemPortADDR2 1 4 }  { state_ce1 MemPortCE2 1 1 }  { state_we1 MemPortWE2 1 1 }  { state_d1 MemPortDIN2 1 8 } } }
