...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("s_axi_CONTROL_BUS_AWADDR", 10, hls_in, -1, "", "", 1),
	...
	Port_Property("s_axi_CONTROL_BUS_ARADDR", 10, hls_in, -1, "", "", 1),
...
const char* HLS_Design_Meta::dut_name = "hls_dijkstra";
