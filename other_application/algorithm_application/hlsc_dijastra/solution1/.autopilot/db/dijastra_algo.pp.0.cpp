...
# 2 "dijastra_algo.cpp" 2
# 1 "/eda/xilinx/Vitis_HLS/2023.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/limits.h" 1 3
# 37 "/eda/xilinx/Vitis_HLS/2023.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/limits.h" 3
...
# 38 "/eda/xilinx/Vitis_HLS/2023.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/limits.h" 2 3
# 3 "dijastra_algo.cpp" 2




void dijkstra(int graph[9][9], int src, int dist[9]) {
...
#pragma HLS ARRAY_PARTITION variable=sptSet complete dim=1
 ...
 VITIS_LOOP_16_1: for (int i = 0; i < 9; i++) {
#pragma HLS UNROLL
 dist[i] = 2147483647;
        sptSet[i] = false;
    }
    ...
    VITIS_LOOP_24_2: for (int count = 0; count < 9 - 1; count++) {


        int u = -1;
        int min_dist = 2147483647;
        VITIS_LOOP_29_3: for (int v = 0; v < 9; v++) {
        ...
        VITIS_LOOP_38_4: for (int v = 0; v < 9; v++) {
...
__attribute__((sdx_kernel("hls_dijkstra", 0))) void hls_dijkstra(int graph[9][9], int src, int dist[9]) {
#line 23 "/home/rrk307/home_hls/python_c_hlsc/other_application/algorithm_application/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=hls_dijkstra
# 46 "dijastra_algo.cpp"
