...
using hls::sim::Byte;
extern "C" void hls_dijkstra(Byte<4>*, int, Byte<4>*);
extern "C" void apatb_hls_dijkstra_hw(volatile void * __xlx_apatb_param_graph, int __xlx_apatb_param_src, volatile void * __xlx_apatb_param_dist) {
using hls::sim::createStream;
  // Collect __xlx_graph__tmp_vec
std::vector<Byte<4>> __xlx_graph__tmp_vec;
for (size_t i = 0; i < 81; ++i){
__xlx_graph__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_graph)[i]);
}
  int __xlx_size_param_graph = 81;
  int __xlx_offset_param_graph = 0;
  int __xlx_offset_byte_param_graph = 0*4;
  // Collect __xlx_dist__tmp_vec
std::vector<Byte<4>> __xlx_dist__tmp_vec;
for (size_t i = 0; i < 9; ++i){
__xlx_dist__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_dist)[i]);
}
  int __xlx_size_param_dist = 9;
  int __xlx_offset_param_dist = 0;
  int __xlx_offset_byte_param_dist = 0*4;
  // DUT call
  hls_dijkstra(__xlx_graph__tmp_vec.data(), __xlx_apatb_param_src, __xlx_dist__tmp_vec.data());
// print __xlx_apatb_param_graph
for (size_t i = 0; i < __xlx_size_param_graph; ++i) {
((Byte<4>*)__xlx_apatb_param_graph)[i] = __xlx_graph__tmp_vec[__xlx_offset_param_graph+i];
}
// print __xlx_apatb_param_dist
for (size_t i = 0; i < __xlx_size_param_dist; ++i) {
((Byte<4>*)__xlx_apatb_param_dist)[i] = __xlx_dist__tmp_vec[__xlx_offset_param_dist+i];
}
}
