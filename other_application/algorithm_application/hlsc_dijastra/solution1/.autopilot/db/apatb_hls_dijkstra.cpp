...
// wrapc file define:
#define AUTOTB_TVIN_graph "../tv/cdatafile/c.hls_dijkstra.autotvin_graph.dat"
#define AUTOTB_TVOUT_graph "../tv/cdatafile/c.hls_dijkstra.autotvout_graph.dat"
#define AUTOTB_TVIN_src "../tv/cdatafile/c.hls_dijkstra.autotvin_src.dat"
#define AUTOTB_TVOUT_src "../tv/cdatafile/c.hls_dijkstra.autotvout_src.dat"
#define AUTOTB_TVIN_dist "../tv/cdatafile/c.hls_dijkstra.autotvin_dist.dat"
#define AUTOTB_TVOUT_dist "../tv/cdatafile/c.hls_dijkstra.autotvout_dist.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_dist "../tv/rtldatafile/rtl.hls_dijkstra.autotvout_dist.dat"
...
extern "C"
void hls_dijkstra_hw_stub_wrapper(void*, hls::sim::Byte<4>, void*);

extern "C"
void apatb_hls_dijkstra_hw(void* __xlx_apatb_param_graph, hls::sim::Byte<4> __xlx_apatb_param_src, void* __xlx_apatb_param_dist)
{
  ...
  port0.param = &__xlx_apatb_param_src;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_graph),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_graph),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_graph };
  port1.nbytes = { 324 };
  port1.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_dist),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_dist),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_dist),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_dist),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_dist),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_dist),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_dist };
  port2.nbytes = { 36 };
  port2.offset = {  };
  port2.hasWrite = { true };
  ...
  try {
    ...
    hls_dijkstra_hw_stub_wrapper(__xlx_apatb_param_graph, __xlx_apatb_param_src, __xlx_apatb_param_dist);
