...
using hls::sim::Byte;
extern "C" void fir_filter(int*, int*, Byte<4>*);
extern "C" void apatb_fir_filter_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, volatile void * __xlx_apatb_param_coeffs) {
using hls::sim::createStream;
auto* sinput_r = createStream((hls::stream<int>*)__xlx_apatb_param_input_r);
  //Create input buffer for output_r
  ap_apatb_output_r_cap_bc = __xlx_output_r_V_size_Reader.read_size();
  int* __xlx_output_r_input_buffer= new int[ap_apatb_output_r_cap_bc];
auto* soutput_r = createStream((hls::stream<int>*)__xlx_apatb_param_output_r);
...
__xlx_coeffs__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_coeffs)[i]);
  ...
  int __xlx_size_param_coeffs = 10;
  int __xlx_offset_param_coeffs = 0;
  int __xlx_offset_byte_param_coeffs = 0*4;
  // DUT call
  fir_filter(sinput_r->data<int>(), soutput_r->data<int>(), __xlx_coeffs__tmp_vec.data());
sinput_r->transfer((hls::stream<int>*)__xlx_apatb_param_input_r);
soutput_r->transfer((hls::stream<int>*)__xlx_apatb_param_output_r);
