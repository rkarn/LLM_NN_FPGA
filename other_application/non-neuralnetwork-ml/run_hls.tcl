...
open_project -reset hlsc_decisiontree

# Add only the source file (not the testbench)
add_files  decisiontree.cpp

# Set the top-level function
set_top iris_decision_tree_inference
...
export_design -format ip_catalog -rtl verilog -output decisiontree_ip
