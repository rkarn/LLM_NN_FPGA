...
unsigned int ap_apatb_input1_cap_bc;
static AESL_RUNTIME_BC __xlx_input1_V_size_Reader("../tv/stream_size/stream_size_in_input1.dat");
unsigned int ap_apatb_input2_cap_bc;
static AESL_RUNTIME_BC __xlx_input2_V_size_Reader("../tv/stream_size/stream_size_in_input2.dat");
...
extern "C" void pingpong_game(int*, int*, __cosim_s32__*);
extern "C" void apatb_pingpong_game_hw(volatile void * __xlx_apatb_param_input1, volatile void * __xlx_apatb_param_input2, volatile void * __xlx_apatb_param_output_r) {
using hls::sim::createStream;
auto* sinput1 = createStream((hls::stream<int>*)__xlx_apatb_param_input1);
auto* sinput2 = createStream((hls::stream<int>*)__xlx_apatb_param_input2);
  //Create input buffer for output_r
  ap_apatb_output_r_cap_bc = __xlx_output_r_V_size_Reader.read_size();
  __cosim_s32__* __xlx_output_r_input_buffer= new __cosim_s32__[ap_apatb_output_r_cap_bc];
auto* soutput_r = createStream((hls::stream<__cosim_s32__>*)__xlx_apatb_param_output_r);
  // DUT call
  pingpong_game(sinput1->data<int>(), sinput2->data<int>(), soutput_r->data<__cosim_s32__>());
sinput1->transfer((hls::stream<int>*)__xlx_apatb_param_input1);
sinput2->transfer((hls::stream<int>*)__xlx_apatb_param_input2);
soutput_r->transfer((hls::stream<__cosim_s32__>*)__xlx_apatb_param_output_r);
}
