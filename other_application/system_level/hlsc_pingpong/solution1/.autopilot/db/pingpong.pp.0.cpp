...
__attribute__((sdx_kernel("pingpong_game", 0))) void pingpong_game(hls::stream<int>& input1, hls::stream<int>& input2, hls::stream<GameState>& output) {
#line 23 "/home/rrk307/home_hls/python_c_hlsc/other_application/system_level/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=pingpong_game
# 56 "pingpong.cpp"
