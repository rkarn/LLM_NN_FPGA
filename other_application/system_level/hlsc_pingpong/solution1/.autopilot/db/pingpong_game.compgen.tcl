...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input1_TDATA { I 32 vector } input1_TVALID { I 1 bit } input1_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input2_TDATA { I 32 vector } input2_TVALID { I 1 bit } input2_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_r_TDATA { O 256 vector } output_r_TVALID { O 1 bit } output_r_TREADY { I 1 bit } } \
} "
} else {
...
# RegSlice definition:
set ID 4
set RegSliceName pingpong_game_regslice_both
set RegSliceInstName pingpong_game_regslice_both_U
set CoreName ap_simcore_pingpong_game_regslice_both
