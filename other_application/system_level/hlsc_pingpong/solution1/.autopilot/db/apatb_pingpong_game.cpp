...
// wrapc file define:
#define AUTOTB_TVIN_input1 "../tv/cdatafile/c.pingpong_game.autotvin_input1.dat"
#define WRAPC_STREAM_SIZE_IN_input1 "../tv/stream_size/stream_size_in_input1.dat"
#define WRAPC_STREAM_INGRESS_STATUS_input1 "../tv/stream_size/stream_ingress_status_input1.dat"
#define AUTOTB_TVIN_input2 "../tv/cdatafile/c.pingpong_game.autotvin_input2.dat"
#define WRAPC_STREAM_SIZE_IN_input2 "../tv/stream_size/stream_size_in_input2.dat"
#define WRAPC_STREAM_INGRESS_STATUS_input2 "../tv/stream_size/stream_ingress_status_input2.dat"
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.pingpong_game.autotvout_output_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.pingpong_game.autotvout_output_r.dat"
...
extern "C"
void pingpong_game_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_pingpong_game_hw(void* __xlx_apatb_param_input1, void* __xlx_apatb_param_input2, void* __xlx_apatb_param_output_r)
{
  static hls::sim::Stream<hls::sim::Byte<4>> port0 {
    .width = 32,
    .name = "input1",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_input1),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_input1),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_input1),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_input1),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_input1;
  ...
  static hls::sim::Stream<hls::sim::Byte<4>> port1 {
    ...
    .name = "input2",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_input2),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_input2),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_input2),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_input2),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_input2;
  ...
  port2.param = (hls::stream<hls::sim::Byte<32>>*)__xlx_apatb_param_output_r;
  port2.hasWrite = true;
  ...
  try {
    ...
    pingpong_game_hw_stub_wrapper(__xlx_apatb_param_input1, __xlx_apatb_param_input2, __xlx_apatb_param_output_r);
    port2.buffer();
