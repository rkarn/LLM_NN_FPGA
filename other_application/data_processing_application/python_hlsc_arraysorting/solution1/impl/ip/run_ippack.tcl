...
set Library     "hls"
set IPName      "hls_quickSort"
set Version     "1.0"
set DisplayName "Hls_quicksort"
set Revision    "2113732328"
...
set xo_kernel_name "hls_quickSort"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/rrk307/home_hls/python_c_hlsc/other_application/data_processing_application/python_hlsc_arraysorting/solution1"
set debug_dir "/home/rrk307/home_hls/python_c_hlsc/other_application/data_processing_application/python_hlsc_arraysorting/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {hls_quickSort_mux_9_4_32_1_1
...
## Variables
set Top "hls_quickSort"
set TopNoPrefix "hls_quickSort"
...
set Interfaces {
    s_axi_CONTROL_BUS {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 arr_0_i W 0x0 "Data signal of arr_0_i" {{0 32 arr_0_i W 0 "Bit 31 to 0 of arr_0_i"}}} {0x18 arr_0_o R 0x0 "Data signal of arr_0_o" {{0 32 arr_0_o R 0 "Bit 31 to 0 of arr_0_o"}}} {0x1c arr_0_o_ctrl R 0x0 "Control signal of arr_0_o" {{0 1 arr_0_o_ap_vld R 0 "Control signal arr_0_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 arr_1_i W 0x0 "Data signal of arr_1_i" {{0 32 arr_1_i W 0 "Bit 31 to 0 of arr_1_i"}}} {0x28 arr_1_o R 0x0 "Data signal of arr_1_o" {{0 32 arr_1_o R 0 "Bit 31 to 0 of arr_1_o"}}} {0x2c arr_1_o_ctrl R 0x0 "Control signal of arr_1_o" {{0 1 arr_1_o_ap_vld R 0 "Control signal arr_1_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 arr_2_i W 0x0 "Data signal of arr_2_i" {{0 32 arr_2_i W 0 "Bit 31 to 0 of arr_2_i"}}} {0x38 arr_2_o R 0x0 "Data signal of arr_2_o" {{0 32 arr_2_o R 0 "Bit 31 to 0 of arr_2_o"}}} {0x3c arr_2_o_ctrl R 0x0 "Control signal of arr_2_o" {{0 1 arr_2_o_ap_vld R 0 "Control signal arr_2_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 arr_3_i W 0x0 "Data signal of arr_3_i" {{0 32 arr_3_i W 0 "Bit 31 to 0 of arr_3_i"}}} {0x48 arr_3_o R 0x0 "Data signal of arr_3_o" {{0 32 arr_3_o R 0 "Bit 31 to 0 of arr_3_o"}}} {0x4c arr_3_o_ctrl R 0x0 "Control signal of arr_3_o" {{0 1 arr_3_o_ap_vld R 0 "Control signal arr_3_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 arr_4_i W 0x0 "Data signal of arr_4_i" {{0 32 arr_4_i W 0 "Bit 31 to 0 of arr_4_i"}}} {0x58 arr_4_o R 0x0 "Data signal of arr_4_o" {{0 32 arr_4_o R 0 "Bit 31 to 0 of arr_4_o"}}} {0x5c arr_4_o_ctrl R 0x0 "Control signal of arr_4_o" {{0 1 arr_4_o_ap_vld R 0 "Control signal arr_4_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 arr_5_i W 0x0 "Data signal of arr_5_i" {{0 32 arr_5_i W 0 "Bit 31 to 0 of arr_5_i"}}} {0x68 arr_5_o R 0x0 "Data signal of arr_5_o" {{0 32 arr_5_o R 0 "Bit 31 to 0 of arr_5_o"}}} {0x6c arr_5_o_ctrl R 0x0 "Control signal of arr_5_o" {{0 1 arr_5_o_ap_vld R 0 "Control signal arr_5_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 arr_6_i W 0x0 "Data signal of arr_6_i" {{0 32 arr_6_i W 0 "Bit 31 to 0 of arr_6_i"}}} {0x78 arr_6_o R 0x0 "Data signal of arr_6_o" {{0 32 arr_6_o R 0 "Bit 31 to 0 of arr_6_o"}}} {0x7c arr_6_o_ctrl R 0x0 "Control signal of arr_6_o" {{0 1 arr_6_o_ap_vld R 0 "Control signal arr_6_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 arr_7_i W 0x0 "Data signal of arr_7_i" {{0 32 arr_7_i W 0 "Bit 31 to 0 of arr_7_i"}}} {0x88 arr_7_o R 0x0 "Data signal of arr_7_o" {{0 32 arr_7_o R 0 "Bit 31 to 0 of arr_7_o"}}} {0x8c arr_7_o_ctrl R 0x0 "Control signal of arr_7_o" {{0 1 arr_7_o_ap_vld R 0 "Control signal arr_7_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 arr_8_i W 0x0 "Data signal of arr_8_i" {{0 32 arr_8_i W 0 "Bit 31 to 0 of arr_8_i"}}} {0x98 arr_8_o R 0x0 "Data signal of arr_8_o" {{0 32 arr_8_o R 0 "Bit 31 to 0 of arr_8_o"}}} {0x9c arr_8_o_ctrl R 0x0 "Control signal of arr_8_o" {{0 1 arr_8_o_ap_vld R 0 "Control signal arr_8_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
