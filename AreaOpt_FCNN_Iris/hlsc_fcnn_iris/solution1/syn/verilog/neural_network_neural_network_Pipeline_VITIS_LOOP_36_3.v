...
wire   [1:0] add_ln36_fu_116_p2;
reg   [1:0] add_ln36_reg_186;
wire   [15:0] trunc_ln38_fu_158_p1;
reg   [15:0] trunc_ln38_reg_199;
wire    ap_CS_fsm_state29;
wire    ap_block_state29_pp0_stage28_iter0;
reg   [1:0] i_fu_46;
wire    ap_loop_init;
reg   [1:0] ap_sig_allocacmp_i_3;
wire   [0:0] icmp_ln38_fu_152_p2;
wire   [15:0] tmp_4_fu_122_p5;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        i_fu_46 <= 2'd0;
    end else if (((icmp_ln36_reg_182 == 1'd0) & (1'b1 == ap_CS_fsm_state30))) begin
...
always @ (*) begin
    if (((icmp_ln36_fu_110_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((i_3_reg_178 == 2'd0)) begin
        if (((icmp_ln36_reg_182 == 1'd0) & (1'b1 == ap_CS_fsm_state30))) begin
            output_0_o = trunc_ln38_reg_199;
        end else if (((1'b1 == ap_CS_fsm_state29) & (icmp_ln38_fu_152_p2 == 1'd1))) begin
            output_0_o = 16'd0;
        end else begin
...
always @ (*) begin
    if ((((icmp_ln36_reg_182 == 1'd0) & (i_3_reg_178 == 2'd0) & (1'b1 == ap_CS_fsm_state30)) | ((i_3_reg_178 == 2'd0) & (1'b1 == ap_CS_fsm_state29) & (icmp_ln38_fu_152_p2 == 1'd1)))) begin
...
always @ (*) begin
    if ((((icmp_ln36_reg_182 == 1'd0) & (i_3_reg_178 == 2'd1) & (1'b1 == ap_CS_fsm_state30)) | ((i_3_reg_178 == 2'd1) & (1'b1 == ap_CS_fsm_state29) & (icmp_ln38_fu_152_p2 == 1'd1)))) begin
...
always @ (*) begin
    if ((~(i_3_reg_178 == 2'd0) & ~(i_3_reg_178 == 2'd1))) begin
        if (((icmp_ln36_reg_182 == 1'd0) & (1'b1 == ap_CS_fsm_state30))) begin
...
always @ (*) begin
    if (((~(i_3_reg_178 == 2'd0) & ~(i_3_reg_178 == 2'd1) & (icmp_ln36_reg_182 == 1'd0) & (1'b1 == ap_CS_fsm_state30)) | (~(i_3_reg_178 == 2'd0) & ~(i_3_reg_178 == 2'd1) & (1'b1 == ap_CS_fsm_state29) & (icmp_ln38_fu_152_p2 == 1'd1)))) begin
...
assign add_ln36_fu_116_p2 = (ap_sig_allocacmp_i_3 + 2'd1);
...
assign icmp_ln36_fu_110_p2 = ((ap_sig_allocacmp_i_3 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln38_fu_152_p2 = ((grp_fu_146_p2 == 25'd0) ? 1'b1 : 1'b0);

assign shl_ln3_fu_134_p3 = {{tmp_4_fu_122_p5}, {8'd0}};

assign trunc_ln38_fu_158_p1 = grp_fu_146_p2[15:0];
