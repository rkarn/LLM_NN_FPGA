; ModuleID = '/home/rrk307/home_hls/python_c_hlsc/AreaOpt_FCNN_Iris/hlsc_fcnn_iris/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a4struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.28"(i16* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.0" %dst_0, i16* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.1" %dst_1, i16* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.2" %dst_2, i16* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.3" %dst_3, [4 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #3 {
entry:
  %0 = icmp eq [4 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a4struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.31"(i16* %dst_0, i16* %dst_1, i16* %dst_2, i16* %dst_3, [4 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 4)
  br label %ret
...
entry:
  call void @"onebyonecpy_hls.p0a4struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.28"(i16* align 512 %_0, i16* align 512 %_1, i16* align 512 %_2, i16* align 512 %_3, [4 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %0)
...
entry:
  ...
  call void @"onebyonecpy_hls.p0a3struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.18"([3 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %1, i16* align 512 %_01, i16* align 512 %_12, i16* align 512 %_23)
  ret void
}
