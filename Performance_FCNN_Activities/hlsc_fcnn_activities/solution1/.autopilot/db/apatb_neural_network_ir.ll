; ModuleID = '/home/rrk307/home_hls/python_c_hlsc/Performance_FCNN_Activities/hlsc_fcnn_activities/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @"onebyonecpy_hls.p0a5struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.16"([5 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %1, i16* align 512 %_01, i16* align 512 %_18, i16* align 512 %_29, i16* align 512 %_310, i16* align 512 %_411)
  ret void
}
