...
architecture behave of neural_network_OUTPUT_s_axi is
    ...
    constant ADDR_OUTPUT_R_BASE : INTEGER := 16#10#;
    ...
    -- memory signals
    signal int_output_r_address0 : UNSIGNED(1 downto 0);
    ...
    signal int_output_r_address1 : UNSIGNED(1 downto 0);
    ...
    component neural_network_OUTPUT_s_axi_ram is
        generic (
    ...
    end component neural_network_OUTPUT_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_output_r
int_output_r : neural_network_OUTPUT_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "T2P",
     BYTES     => 4,
...
-- ----------------------- Memory logic ------------------
    -- output_r
    int_output_r_address0 <= SHIFT_RIGHT(UNSIGNED(output_r_address0), 1)(1 downto 0);
    ...
    int_output_r_address1 <= raddr(3 downto 2) when ar_hs = '1' else waddr(3 downto 2);
...
entity neural_network_OUTPUT_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity neural_network_OUTPUT_s_axi_ram;

architecture behave of neural_network_OUTPUT_s_axi_ram is
