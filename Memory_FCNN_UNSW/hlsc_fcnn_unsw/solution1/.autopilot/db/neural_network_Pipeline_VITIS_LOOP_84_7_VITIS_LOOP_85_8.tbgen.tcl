...
set C_modelArgList {
	{ layer2_weight_tile int 13 regular {array 10 { 0 3 } 0 1 }  }
	{ zext_ln82 int 6 regular  }
	{ layer2_weight_tile_1 int 13 regular {array 10 { 0 3 } 0 1 }  }
	{ layer2_weight_tile_2 int 13 regular {array 10 { 0 3 } 0 1 }  }
	{ layer2_weight_tile_3 int 13 regular {array 10 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer2_weight_tile", "interface" : "memory", "bitwidth" : 13, "direction" : "WRITEONLY"} , 
 	{ "Name" : "zext_ln82", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "layer2_weight_tile_1", "interface" : "memory", "bitwidth" : 13, "direction" : "WRITEONLY"} , 
 	{ "Name" : "layer2_weight_tile_2", "interface" : "memory", "bitwidth" : 13, "direction" : "WRITEONLY"} , 
 	{ "Name" : "layer2_weight_tile_3", "interface" : "memory", "bitwidth" : 13, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer2_weight_tile_1_d0 sc_out sc_lv 13 signal 2 } 
	...
	{ layer2_weight_tile_2_d0 sc_out sc_lv 13 signal 3 } 
	...
	{ layer2_weight_tile_3_d0 sc_out sc_lv 13 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer2_weight_tile_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "layer2_weight_tile", "role": "d0" }} , 
 	...
 	{ "name": "layer2_weight_tile_1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "layer2_weight_tile_1", "role": "d0" }} , 
 	...
 	{ "name": "layer2_weight_tile_2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "layer2_weight_tile_2", "role": "d0" }} , 
 	...
 	{ "name": "layer2_weight_tile_3_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "layer2_weight_tile_3", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	layer2_weight_tile { ap_memory {  { layer2_weight_tile_address0 mem_address 1 4 }  { layer2_weight_tile_ce0 mem_ce 1 1 }  { layer2_weight_tile_we0 mem_we 1 1 }  { layer2_weight_tile_d0 mem_din 1 13 } } }
	zext_ln82 { ap_none {  { zext_ln82 in_data 0 6 } } }
	layer2_weight_tile_1 { ap_memory {  { layer2_weight_tile_1_address0 mem_address 1 4 }  { layer2_weight_tile_1_ce0 mem_ce 1 1 }  { layer2_weight_tile_1_we0 mem_we 1 1 }  { layer2_weight_tile_1_d0 mem_din 1 13 } } }
	layer2_weight_tile_2 { ap_memory {  { layer2_weight_tile_2_address0 mem_address 1 4 }  { layer2_weight_tile_2_ce0 mem_ce 1 1 }  { layer2_weight_tile_2_we0 mem_we 1 1 }  { layer2_weight_tile_2_d0 mem_din 1 13 } } }
	layer2_weight_tile_3 { ap_memory {  { layer2_weight_tile_3_address0 mem_address 1 4 }  { layer2_weight_tile_3_ce0 mem_ce 1 1 }  { layer2_weight_tile_3_we0 mem_we 1 1 }  { layer2_weight_tile_3_d0 mem_din 1 13 } } }
}
