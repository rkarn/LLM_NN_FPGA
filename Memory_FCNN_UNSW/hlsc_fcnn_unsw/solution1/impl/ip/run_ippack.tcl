...
set xo_kernel_name "neural_network"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/rrk307/home_hls/python_c_hlsc/Memory_FCNN_UNSW/hlsc_fcnn_unsw/solution1"
set debug_dir "/home/rrk307/home_hls/python_c_hlsc/Memory_FCNN_UNSW/hlsc_fcnn_unsw/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {neural_network_ama_addmuladd_6ns_6ns_6ns_6ns_12_4_1
...
set TopNoPrefix "neural_network"
...
set Interfaces {
    ...
    s_axi_OUTPUT {
        ...
        registers {{0x10 output_0_i W 0x0 "Data signal of output_0_i" {{0 16 output_0_i W 0 "Bit 15 to 0 of output_0_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 output_0_o R 0x0 "Data signal of output_0_o" {{0 16 output_0_o R 0 "Bit 15 to 0 of output_0_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x1c output_0_o_ctrl R 0x0 "Control signal of output_0_o" {{0 1 output_0_o_ap_vld R 0 "Control signal output_0_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 output_1_i W 0x0 "Data signal of output_1_i" {{0 16 output_1_i W 0 "Bit 15 to 0 of output_1_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 output_1_o R 0x0 "Data signal of output_1_o" {{0 16 output_1_o R 0 "Bit 15 to 0 of output_1_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x2c output_1_o_ctrl R 0x0 "Control signal of output_1_o" {{0 1 output_1_o_ap_vld R 0 "Control signal output_1_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 output_2_i W 0x0 "Data signal of output_2_i" {{0 16 output_2_i W 0 "Bit 15 to 0 of output_2_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 output_2_o R 0x0 "Data signal of output_2_o" {{0 16 output_2_o R 0 "Bit 15 to 0 of output_2_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x3c output_2_o_ctrl R 0x0 "Control signal of output_2_o" {{0 1 output_2_o_ap_vld R 0 "Control signal output_2_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 output_3_i W 0x0 "Data signal of output_3_i" {{0 16 output_3_i W 0 "Bit 15 to 0 of output_3_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 output_3_o R 0x0 "Data signal of output_3_o" {{0 16 output_3_o R 0 "Bit 15 to 0 of output_3_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x4c output_3_o_ctrl R 0x0 "Control signal of output_3_o" {{0 1 output_3_o_ap_vld R 0 "Control signal output_3_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 output_4_i W 0x0 "Data signal of output_4_i" {{0 16 output_4_i W 0 "Bit 15 to 0 of output_4_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 output_4_o R 0x0 "Data signal of output_4_o" {{0 16 output_4_o R 0 "Bit 15 to 0 of output_4_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x5c output_4_o_ctrl R 0x0 "Control signal of output_4_o" {{0 1 output_4_o_ap_vld R 0 "Control signal output_4_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 output_5_i W 0x0 "Data signal of output_5_i" {{0 16 output_5_i W 0 "Bit 15 to 0 of output_5_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 output_5_o R 0x0 "Data signal of output_5_o" {{0 16 output_5_o R 0 "Bit 15 to 0 of output_5_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x6c output_5_o_ctrl R 0x0 "Control signal of output_5_o" {{0 1 output_5_o_ap_vld R 0 "Control signal output_5_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 output_6_i W 0x0 "Data signal of output_6_i" {{0 16 output_6_i W 0 "Bit 15 to 0 of output_6_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 output_6_o R 0x0 "Data signal of output_6_o" {{0 16 output_6_o R 0 "Bit 15 to 0 of output_6_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x7c output_6_o_ctrl R 0x0 "Control signal of output_6_o" {{0 1 output_6_o_ap_vld R 0 "Control signal output_6_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 output_7_i W 0x0 "Data signal of output_7_i" {{0 16 output_7_i W 0 "Bit 15 to 0 of output_7_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 output_7_o R 0x0 "Data signal of output_7_o" {{0 16 output_7_o R 0 "Bit 15 to 0 of output_7_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x8c output_7_o_ctrl R 0x0 "Control signal of output_7_o" {{0 1 output_7_o_ap_vld R 0 "Control signal output_7_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 output_8_i W 0x0 "Data signal of output_8_i" {{0 16 output_8_i W 0 "Bit 15 to 0 of output_8_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 output_8_o R 0x0 "Data signal of output_8_o" {{0 16 output_8_o R 0 "Bit 15 to 0 of output_8_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x9c output_8_o_ctrl R 0x0 "Control signal of output_8_o" {{0 1 output_8_o_ap_vld R 0 "Control signal output_8_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 output_9_i W 0x0 "Data signal of output_9_i" {{0 16 output_9_i W 0 "Bit 15 to 0 of output_9_i"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xa8 output_9_o R 0x0 "Data signal of output_9_o" {{0 16 output_9_o R 0 "Bit 15 to 0 of output_9_o"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xac output_9_o_ctrl R 0x0 "Control signal of output_9_o" {{0 1 output_9_o_ap_vld R 0 "Control signal output_9_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL s_axi_INPUT s_axi_OUTPUT"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 8946 II x}
