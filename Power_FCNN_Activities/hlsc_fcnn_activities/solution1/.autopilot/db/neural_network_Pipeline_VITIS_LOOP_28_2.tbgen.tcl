...
set C_modelArgList {
	{ layer2_output int 16 regular {array 5 { 1 3 } 1 1 }  }
	{ conv_i_i13_i_i8 int 16 regular  }
	{ output_r int 16 regular {array 5 { 0 } 0 1 }  }
...
set portList { 
	...
	{ layer2_output_address0 sc_out sc_lv 3 signal 0 } 
	{ layer2_output_ce0 sc_out sc_logic 1 signal 0 } 
	{ layer2_output_q0 sc_in sc_lv 16 signal 0 } 
	{ conv_i_i13_i_i8 sc_in sc_lv 16 signal 1 } 
	...
	{ sum_4_out sc_out sc_lv 16 signal 3 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_25ns_25ns_50_1_1_U131", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_25ns_18ns_43_1_1_U132", "Parent" : "0"},
...
set Spec2ImplPortList { 
	layer2_output { ap_memory {  { layer2_output_address0 mem_address 1 3 }  { layer2_output_ce0 mem_ce 1 1 }  { layer2_output_q0 in_data 0 16 } } }
	conv_i_i13_i_i8 { ap_none {  { conv_i_i13_i_i8 in_data 0 16 } } }
	output_r { ap_memory {  { output_r_address0 mem_address 1 3 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 16 } } }
