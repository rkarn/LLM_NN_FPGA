...
using hls::sim::Byte;
extern "C" void neural_network(Byte<2>*, Byte<2>*);
extern "C" void apatb_neural_network_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_input_r__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_input_r)[i]);
  ...
  int __xlx_size_param_input_r = 43;
...
__xlx_output_r__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  neural_network(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data());
