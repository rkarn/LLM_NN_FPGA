...
//------------------------Instantiation------------------
// int_output_r
neural_network_OUTPUT_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "T2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 3 )
...
assign int_output_r_address1 = ar_hs? raddr[3:2] : waddr[3:2];
...
module neural_network_OUTPUT_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
