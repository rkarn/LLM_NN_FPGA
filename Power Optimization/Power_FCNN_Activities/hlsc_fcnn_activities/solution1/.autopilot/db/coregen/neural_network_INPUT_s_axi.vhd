...
architecture behave of neural_network_INPUT_s_axi is
    ...
    constant ADDR_INPUT_R_BASE : INTEGER := 16#40#;
    constant ADDR_INPUT_R_HIGH : INTEGER := 16#7f#;
    ...
    -- memory signals
    signal int_input_r_address0 : UNSIGNED(3 downto 0);
    signal int_input_r_ce0     : STD_LOGIC;
    signal int_input_r_q0      : UNSIGNED(31 downto 0);
    signal int_input_r_address1 : UNSIGNED(3 downto 0);
    ...
    component neural_network_INPUT_s_axi_ram is
        generic (
    ...
    end component neural_network_INPUT_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_input_r
int_input_r : neural_network_INPUT_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- ----------------------- Memory logic ------------------
    -- input_r
    int_input_r_address0 <= SHIFT_RIGHT(UNSIGNED(input_r_address0), 1)(3 downto 0);
    ...
    int_input_r_address1 <= raddr(5 downto 2) when ar_hs = '1' else waddr(5 downto 2);
...
entity neural_network_INPUT_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity neural_network_INPUT_s_axi_ram;

architecture behave of neural_network_INPUT_s_axi_ram is
