...
set solution_dir "/home/rrk307/home_hls/python_c_hlsc/Performance_FCNN_UNSW/hlsc_fcnn_unsw/solution1"
set debug_dir "/home/rrk307/home_hls/python_c_hlsc/Performance_FCNN_UNSW/hlsc_fcnn_unsw/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {neural_network_mul_25ns_25ns_50_1_1
...
set Interfaces {
    ...
    s_axi_OUTPUT {
        ...
        registers {{0x10 output_0 R 0x0 "Data signal of output_0" {{0 16 output_0 R 0 "Bit 15 to 0 of output_0"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x14 output_0_ctrl R 0x0 "Control signal of output_0" {{0 1 output_0_ap_vld R 0 "Control signal output_0_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 output_1 R 0x0 "Data signal of output_1" {{0 16 output_1 R 0 "Bit 15 to 0 of output_1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x24 output_1_ctrl R 0x0 "Control signal of output_1" {{0 1 output_1_ap_vld R 0 "Control signal output_1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 output_2 R 0x0 "Data signal of output_2" {{0 16 output_2 R 0 "Bit 15 to 0 of output_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x34 output_2_ctrl R 0x0 "Control signal of output_2" {{0 1 output_2_ap_vld R 0 "Control signal output_2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 output_3 R 0x0 "Data signal of output_3" {{0 16 output_3 R 0 "Bit 15 to 0 of output_3"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x44 output_3_ctrl R 0x0 "Control signal of output_3" {{0 1 output_3_ap_vld R 0 "Control signal output_3_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 output_4 R 0x0 "Data signal of output_4" {{0 16 output_4 R 0 "Bit 15 to 0 of output_4"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x54 output_4_ctrl R 0x0 "Control signal of output_4" {{0 1 output_4_ap_vld R 0 "Control signal output_4_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 output_5 R 0x0 "Data signal of output_5" {{0 16 output_5 R 0 "Bit 15 to 0 of output_5"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x64 output_5_ctrl R 0x0 "Control signal of output_5" {{0 1 output_5_ap_vld R 0 "Control signal output_5_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 output_6 R 0x0 "Data signal of output_6" {{0 16 output_6 R 0 "Bit 15 to 0 of output_6"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x74 output_6_ctrl R 0x0 "Control signal of output_6" {{0 1 output_6_ap_vld R 0 "Control signal output_6_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 output_7 R 0x0 "Data signal of output_7" {{0 16 output_7 R 0 "Bit 15 to 0 of output_7"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x84 output_7_ctrl R 0x0 "Control signal of output_7" {{0 1 output_7_ap_vld R 0 "Control signal output_7_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 output_8 R 0x0 "Data signal of output_8" {{0 16 output_8 R 0 "Bit 15 to 0 of output_8"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x94 output_8_ctrl R 0x0 "Control signal of output_8" {{0 1 output_8_ap_vld R 0 "Control signal output_8_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 output_9 R 0x0 "Data signal of output_9" {{0 16 output_9 R 0 "Bit 15 to 0 of output_9"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xa4 output_9_ctrl R 0x0 "Control signal of output_9" {{0 1 output_9_ap_vld R 0 "Control signal output_9_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 69 II 1}
