...
architecture behave of neural_network_OUTPUT_s_axi is
    ...
    constant ADDR_OUTPUT_0_DATA_0 : INTEGER := 16#10#;
    constant ADDR_OUTPUT_0_CTRL   : INTEGER := 16#14#;
    constant ADDR_OUTPUT_1_DATA_0 : INTEGER := 16#20#;
    constant ADDR_OUTPUT_1_CTRL   : INTEGER := 16#24#;
    constant ADDR_OUTPUT_2_DATA_0 : INTEGER := 16#30#;
    constant ADDR_OUTPUT_2_CTRL   : INTEGER := 16#34#;
    constant ADDR_OUTPUT_3_DATA_0 : INTEGER := 16#40#;
    constant ADDR_OUTPUT_3_CTRL   : INTEGER := 16#44#;
    constant ADDR_OUTPUT_4_DATA_0 : INTEGER := 16#50#;
    constant ADDR_OUTPUT_4_CTRL   : INTEGER := 16#54#;
    constant ADDR_OUTPUT_5_DATA_0 : INTEGER := 16#60#;
    constant ADDR_OUTPUT_5_CTRL   : INTEGER := 16#64#;
    constant ADDR_OUTPUT_6_DATA_0 : INTEGER := 16#70#;
    constant ADDR_OUTPUT_6_CTRL   : INTEGER := 16#74#;
    constant ADDR_OUTPUT_7_DATA_0 : INTEGER := 16#80#;
    constant ADDR_OUTPUT_7_CTRL   : INTEGER := 16#84#;
    constant ADDR_OUTPUT_8_DATA_0 : INTEGER := 16#90#;
    constant ADDR_OUTPUT_8_CTRL   : INTEGER := 16#94#;
    constant ADDR_OUTPUT_9_DATA_0 : INTEGER := 16#a0#;
    constant ADDR_OUTPUT_9_CTRL   : INTEGER := 16#a4#;
