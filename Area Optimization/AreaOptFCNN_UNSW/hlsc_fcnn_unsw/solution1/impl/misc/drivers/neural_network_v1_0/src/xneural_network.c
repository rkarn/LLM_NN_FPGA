...
void XNeural_network_Set_output_0_i(XNeural_network *InstancePtr, u32 Data) {
    ...
    XNeural_network_WriteReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_0_I_DATA, Data);
}
...
u32 XNeural_network_Get_output_0_i(XNeural_network *InstancePtr) {
    ...
    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_0_I_DATA);
    return Data;
}
...
u32 XNeural_network_Get_output_0_o(XNeural_network *InstancePtr) {
    ...
    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_0_O_DATA);
    return Data;
}
...
u32 XNeural_network_Get_output_0_o_vld(XNeural_network *InstancePtr) {
    ...
    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_0_O_CTRL);
    return Data & 0x1;
}
...
void XNeural_network_Set_output_1_i(XNeural_network *InstancePtr, u32 Data) {
    ...
    XNeural_network_WriteReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_1_I_DATA, Data);
}
...
u32 XNeural_network_Get_output_1_i(XNeural_network *InstancePtr) {
    ...
    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_1_I_DATA);
    return Data;
}
...
u32 XNeural_network_Get_output_1_o(XNeural_network *InstancePtr) {
    ...
    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_1_O_DATA);
    return Data;
}
...
u32 XNeural_network_Get_output_1_o_vld(XNeural_network *InstancePtr) {
    ...
    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_1_O_CTRL);
    return Data & 0x1;
}
...
void XNeural_network_Set_output_2_i(XNeural_network *InstancePtr, u32 Data) {
    ...
    XNeural_network_WriteReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_2_I_DATA, Data);
}
...
u32 XNeural_network_Get_output_2_i(XNeural_network *InstancePtr) {
    ...
    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_2_I_DATA);
    return Data;
}
...
u32 XNeural_network_Get_output_2_o(XNeural_network *InstancePtr) {
    ...
    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_2_O_DATA);
    return Data;
}
...
u32 XNeural_network_Get_output_2_o_vld(XNeural_network *InstancePtr) {
    ...
    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_2_O_CTRL);
    return Data & 0x1;
}

void XNeural_network_Set_output_3_i(XNeural_network *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XNeural_network_WriteReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_3_I_DATA, Data);
}

u32 XNeural_network_Get_output_3_i(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_3_I_DATA);
    return Data;
}

u32 XNeural_network_Get_output_3_o(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_3_O_DATA);
    return Data;
}

u32 XNeural_network_Get_output_3_o_vld(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_3_O_CTRL);
    return Data & 0x1;
}

void XNeural_network_Set_output_4_i(XNeural_network *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XNeural_network_WriteReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_4_I_DATA, Data);
}

u32 XNeural_network_Get_output_4_i(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_4_I_DATA);
    return Data;
}

u32 XNeural_network_Get_output_4_o(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_4_O_DATA);
    return Data;
}

u32 XNeural_network_Get_output_4_o_vld(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_4_O_CTRL);
    return Data & 0x1;
}

void XNeural_network_Set_output_5_i(XNeural_network *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XNeural_network_WriteReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_5_I_DATA, Data);
}

u32 XNeural_network_Get_output_5_i(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_5_I_DATA);
    return Data;
}

u32 XNeural_network_Get_output_5_o(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_5_O_DATA);
    return Data;
}

u32 XNeural_network_Get_output_5_o_vld(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_5_O_CTRL);
    return Data & 0x1;
}

void XNeural_network_Set_output_6_i(XNeural_network *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XNeural_network_WriteReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_6_I_DATA, Data);
}

u32 XNeural_network_Get_output_6_i(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_6_I_DATA);
    return Data;
}

u32 XNeural_network_Get_output_6_o(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_6_O_DATA);
    return Data;
}

u32 XNeural_network_Get_output_6_o_vld(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_6_O_CTRL);
    return Data & 0x1;
}

void XNeural_network_Set_output_7_i(XNeural_network *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XNeural_network_WriteReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_7_I_DATA, Data);
}

u32 XNeural_network_Get_output_7_i(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_7_I_DATA);
    return Data;
}

u32 XNeural_network_Get_output_7_o(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_7_O_DATA);
    return Data;
}

u32 XNeural_network_Get_output_7_o_vld(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_7_O_CTRL);
    return Data & 0x1;
}

void XNeural_network_Set_output_8_i(XNeural_network *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XNeural_network_WriteReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_8_I_DATA, Data);
}

u32 XNeural_network_Get_output_8_i(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_8_I_DATA);
    return Data;
}

u32 XNeural_network_Get_output_8_o(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_8_O_DATA);
    return Data;
}

u32 XNeural_network_Get_output_8_o_vld(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_8_O_CTRL);
    return Data & 0x1;
}

void XNeural_network_Set_output_9_i(XNeural_network *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XNeural_network_WriteReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_9_I_DATA, Data);
}

u32 XNeural_network_Get_output_9_i(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_9_I_DATA);
    return Data;
}

u32 XNeural_network_Get_output_9_o(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_9_O_DATA);
    return Data;
}

u32 XNeural_network_Get_output_9_o_vld(XNeural_network *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNeural_network_ReadReg(InstancePtr->Output_BaseAddress, XNEURAL_NETWORK_OUTPUT_ADDR_OUTPUT_9_O_CTRL);
    return Data & 0x1;
}
