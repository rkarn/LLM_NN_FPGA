...
reg   [3:0] i_2_fu_54;
wire   [3:0] add_ln23_fu_187_p2;
reg   [3:0] ap_sig_allocacmp_i;
wire   [15:0] tmp_fu_147_p12;
wire   [0:0] icmp_ln25_fu_173_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if ((icmp_ln23_fu_138_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln23_fu_138_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign add_ln23_fu_187_p2 = (ap_sig_allocacmp_i + 4'd1);
...
assign icmp_ln23_fu_138_p2 = ((ap_sig_allocacmp_i == 4'd10) ? 1'b1 : 1'b0);

assign icmp_ln25_fu_173_p2 = (($signed(tmp_fu_147_p12) > $signed(ap_sig_allocacmp_max_val_load_1)) ? 1'b1 : 1'b0);

assign max_val_1_fu_179_p3 = ((icmp_ln25_fu_173_p2[0:0] == 1'b1) ? tmp_fu_147_p12 : ap_sig_allocacmp_max_val_load_1);
