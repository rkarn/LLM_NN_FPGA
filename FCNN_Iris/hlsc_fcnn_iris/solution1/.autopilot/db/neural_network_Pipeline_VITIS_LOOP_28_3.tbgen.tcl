set moduleName neural_network_Pipeline_VITIS_LOOP_28_3
set isTopModule 0
...
set C_modelName {neural_network_Pipeline_VITIS_LOOP_28_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_r int 16 regular {array 3 { 2 } 1 1 }  }
	{ sum_1_cast int 16 regular  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "output_r", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} , 
 	{ "Name" : "sum_1_cast", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ output_r_address0 sc_out sc_lv 2 signal 0 } 
	...
	{ sum_1_cast sc_in sc_lv 16 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_1_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sum_1_cast", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_24ns_16s_16_28_1_U76", "Parent" : "0"},
...
set Spec2ImplPortList { 
	output_r { ap_memory {  { output_r_address0 mem_address 1 2 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 16 }  { output_r_q0 in_data 0 16 } } }
	sum_1_cast { ap_none {  { sum_1_cast in_data 0 16 } } }
}
