; ModuleID = '/home/rrk307/home_hls/python_c_hlsc/FCNN_Iris/hlsc_fcnn_iris/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  call fastcc void @"onebyonecpy_hls.p0a4struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.30"([4 x i16]* align 512 %1, [4 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %0)
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a3struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.20"([3 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %2, [3 x i16]* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a3struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.20"([3 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* noalias "unpacked"="0" %dst, [3 x i16]* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [3 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a3struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.23"([3 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, [3 x i16]* %src, i64 3)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a3struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.23"([3 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* "unpacked"="0" %dst, [3 x i16]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [3 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a4struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.30"([4 x i16]* noalias nocapture align 512 "unpacked"="0.0" %dst, [4 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* noalias readonly "unpacked"="1" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [4 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a4struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.33"([4 x i16]* %dst, [4 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 4)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a4struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>.33"([4 x i16]* nocapture "unpacked"="0.0" %dst, [4 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #3 {
entry:
  %0 = icmp eq [4 x %"struct.ap_fixed<16, 8, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy
