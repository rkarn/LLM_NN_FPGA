...
//------------------------Parameter----------------------
localparam
    ADDR_INPUT_R_BASE = 7'h40,
    ADDR_INPUT_R_HIGH = 7'h7f,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [3:0]                    int_input_r_address0;
    wire                          int_input_r_ce0;
    wire [31:0]                   int_input_r_q0;
    wire [3:0]                    int_input_r_address1;
...
//------------------------Instantiation------------------
// int_input_r
neural_network_INPUT_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 9 )
...
assign int_input_r_address1 = ar_hs? raddr[5:2] : waddr[5:2];
...
module neural_network_INPUT_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
