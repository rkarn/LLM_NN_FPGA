...
reg   [1:0] i_3_fu_40;
wire   [1:0] add_ln21_fu_117_p2;
reg   [1:0] ap_sig_allocacmp_i;
wire   [15:0] tmp_fu_91_p5;
wire   [0:0] icmp_ln23_fu_103_p2;
reg    ap_done_reg;
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln21_fu_82_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln21_fu_117_p2 = (ap_sig_allocacmp_i + 2'd1);
...
assign icmp_ln21_fu_82_p2 = ((ap_sig_allocacmp_i == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln23_fu_103_p2 = (($signed(tmp_fu_91_p5) > $signed(ap_sig_allocacmp_max_val_load_1)) ? 1'b1 : 1'b0);

assign max_val_1_fu_109_p3 = ((icmp_ln23_fu_103_p2[0:0] == 1'b1) ? tmp_fu_91_p5 : ap_sig_allocacmp_max_val_load_1);
