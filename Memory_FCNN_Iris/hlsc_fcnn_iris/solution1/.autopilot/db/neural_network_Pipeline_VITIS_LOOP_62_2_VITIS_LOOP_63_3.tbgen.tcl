...
set C_modelArgList {
	{ layer1_weight_tile int 9 regular {array 4 { 0 3 } 0 1 }  }
	{ trunc_ln int 3 regular  }
	{ layer1_weight_tile_3 int 9 regular {array 4 { 0 3 } 0 1 }  }
	{ layer1_weight_tile_2 int 9 regular {array 4 { 0 3 } 0 1 }  }
	{ layer1_weight_tile_1 int 9 regular {array 4 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set C_modelArgMapList {[ 
	{ "Name" : "layer1_weight_tile", "interface" : "memory", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "trunc_ln", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "layer1_weight_tile_3", "interface" : "memory", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "layer1_weight_tile_2", "interface" : "memory", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "layer1_weight_tile_1", "interface" : "memory", "bitwidth" : 9, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer1_weight_tile_d0 sc_out sc_lv 9 signal 0 } 
	{ trunc_ln sc_in sc_lv 3 signal 1 } 
	{ layer1_weight_tile_3_address0 sc_out sc_lv 2 signal 2 } 
	{ layer1_weight_tile_3_ce0 sc_out sc_logic 1 signal 2 } 
	{ layer1_weight_tile_3_we0 sc_out sc_logic 1 signal 2 } 
	{ layer1_weight_tile_3_d0 sc_out sc_lv 9 signal 2 } 
	{ layer1_weight_tile_2_address0 sc_out sc_lv 2 signal 3 } 
	{ layer1_weight_tile_2_ce0 sc_out sc_logic 1 signal 3 } 
	{ layer1_weight_tile_2_we0 sc_out sc_logic 1 signal 3 } 
	{ layer1_weight_tile_2_d0 sc_out sc_lv 9 signal 3 } 
	{ layer1_weight_tile_1_address0 sc_out sc_lv 2 signal 4 } 
	{ layer1_weight_tile_1_ce0 sc_out sc_logic 1 signal 4 } 
	{ layer1_weight_tile_1_we0 sc_out sc_logic 1 signal 4 } 
	{ layer1_weight_tile_1_d0 sc_out sc_lv 9 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer1_weight_tile_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "layer1_weight_tile", "role": "d0" }} , 
 	...
 	{ "name": "layer1_weight_tile_3_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "layer1_weight_tile_3", "role": "d0" }} , 
 	...
 	{ "name": "layer1_weight_tile_2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "layer1_weight_tile_2", "role": "d0" }} , 
 	...
 	{ "name": "layer1_weight_tile_1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "layer1_weight_tile_1", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	layer1_weight_tile { ap_memory {  { layer1_weight_tile_address0 mem_address 1 2 }  { layer1_weight_tile_ce0 mem_ce 1 1 }  { layer1_weight_tile_we0 mem_we 1 1 }  { layer1_weight_tile_d0 mem_din 1 9 } } }
	trunc_ln { ap_none {  { trunc_ln in_data 0 3 } } }
	layer1_weight_tile_3 { ap_memory {  { layer1_weight_tile_3_address0 mem_address 1 2 }  { layer1_weight_tile_3_ce0 mem_ce 1 1 }  { layer1_weight_tile_3_we0 mem_we 1 1 }  { layer1_weight_tile_3_d0 mem_din 1 9 } } }
	layer1_weight_tile_2 { ap_memory {  { layer1_weight_tile_2_address0 mem_address 1 2 }  { layer1_weight_tile_2_ce0 mem_ce 1 1 }  { layer1_weight_tile_2_we0 mem_we 1 1 }  { layer1_weight_tile_2_d0 mem_din 1 9 } } }
	layer1_weight_tile_1 { ap_memory {  { layer1_weight_tile_1_address0 mem_address 1 2 }  { layer1_weight_tile_1_ce0 mem_ce 1 1 }  { layer1_weight_tile_1_we0 mem_we 1 1 }  { layer1_weight_tile_1_d0 mem_din 1 9 } } }
}
