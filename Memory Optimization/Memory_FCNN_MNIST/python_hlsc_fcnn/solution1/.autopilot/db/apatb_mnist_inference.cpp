...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.mnist_inference.autotvin_input_r.dat"
#define AUTOTB_TVOUT_input_r "../tv/cdatafile/c.mnist_inference.autotvout_input_r.dat"
...
extern "C"
void mnist_inference_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_mnist_inference_hw(void* __xlx_apatb_param_input_r, void* __xlx_apatb_param_output_r)
{
#ifdef USE_BINARY_TV_FILE
  ...
  try {
    ...
    mnist_inference_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r);
