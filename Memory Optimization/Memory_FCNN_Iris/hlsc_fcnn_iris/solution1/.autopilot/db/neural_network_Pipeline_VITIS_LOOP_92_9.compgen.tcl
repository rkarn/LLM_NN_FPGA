...
set id 33
set name neural_network_mux_4_2_6_1_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { layer2_weight_tile_address0 { O 2 vector } layer2_weight_tile_ce0 { O 1 bit } layer2_weight_tile_q0 { I 10 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { layer2_weight_tile_1_address0 { O 2 vector } layer2_weight_tile_1_ce0 { O 1 bit } layer2_weight_tile_1_q0 { I 10 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { layer2_weight_tile_2_address0 { O 2 vector } layer2_weight_tile_2_ce0 { O 1 bit } layer2_weight_tile_2_q0 { I 10 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { layer2_weight_tile_3_address0 { O 2 vector } layer2_weight_tile_3_ce0 { O 1 bit } layer2_weight_tile_3_q0 { I 10 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { layer1_output_address0 { O 1 vector } layer1_output_ce0 { O 1 bit } layer1_output_q0 { I 15 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { layer1_output_1_address0 { O 1 vector } layer1_output_1_ce0 { O 1 bit } layer1_output_1_q0 { I 15 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { layer1_output_2_address0 { O 1 vector } layer1_output_2_ce0 { O 1 bit } layer1_output_2_q0 { I 15 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { layer1_output_3_address0 { O 1 vector } layer1_output_3_ce0 { O 1 bit } layer1_output_3_q0 { I 15 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 42 \
    name conv_i_i_le8_lcssa15 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_conv_i_i_le8_lcssa15 \
    op interface \
    ports { conv_i_i_le8_lcssa15 { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 55 \
    name conv_i_i_le9_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_conv_i_i_le9_out \
    op interface \
    ports { conv_i_i_le9_out { O 16 vector } conv_i_i_le9_out_ap_vld { O 1 bit } } \
} "
}
