...
attribute shreg_extract : string;
    ...
    signal i_3_fu_54 : STD_LOGIC_VECTOR (3 downto 0);
    signal add_ln21_fu_187_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_sig_allocacmp_i : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_fu_147_p12 : STD_LOGIC_VECTOR (15 downto 0);
    signal icmp_ln23_fu_173_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    mux_10_4_16_1_1_U220 : component neural_network_mux_10_4_16_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                if ((icmp_ln21_fu_138_p2 = ap_const_lv1_0)) then 
                    i_3_fu_54 <= add_ln21_fu_187_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    i_3_fu_54 <= ap_const_lv4_1;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln21_fu_187_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv4_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_state1, icmp_ln21_fu_138_p2, ap_start_int)
    begin
        if (((icmp_ln21_fu_138_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_state1, ap_loop_init, i_3_fu_54)
    begin
    ...
    ap_sig_allocacmp_max_val_load_1_assign_proc : process(ap_CS_fsm_state1, p_0_0_0114_i1, max_val_fu_50, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    icmp_ln21_fu_138_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv4_A) else "0";
    icmp_ln23_fu_173_p2 <= "1" when (signed(tmp_fu_147_p12) > signed(ap_sig_allocacmp_max_val_load_1)) else "0";
    max_val_1_fu_179_p3 <= 
        tmp_fu_147_p12 when (icmp_ln23_fu_173_p2(0) = '1') else 
        ap_sig_allocacmp_max_val_load_1;
    max_val_out <= max_val_fu_50;

    max_val_out_ap_vld_assign_proc : process(ap_CS_fsm_state1, icmp_ln21_fu_138_p2, ap_start_int)
    begin
        if (((icmp_ln21_fu_138_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
