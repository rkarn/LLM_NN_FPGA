...
//------------------------Parameter----------------------
localparam
    ADDR_INPUT_0_DATA_0 = 6'h10,
    ADDR_INPUT_0_CTRL   = 6'h14,
    ADDR_INPUT_1_DATA_0 = 6'h18,
    ADDR_INPUT_1_CTRL   = 6'h1c,
    ADDR_INPUT_2_DATA_0 = 6'h20,
    ADDR_INPUT_2_CTRL   = 6'h24,
    ADDR_INPUT_3_DATA_0 = 6'h28,
    ADDR_INPUT_3_CTRL   = 6'h2c,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
